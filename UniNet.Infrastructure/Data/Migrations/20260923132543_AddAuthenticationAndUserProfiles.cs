...
{
    /// <inheritdoc />
    public partial class AddAuthenticationAndUserProfiles : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleEmail = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Accounts_Role", "\"Role\" BETWEEN 0 AND 2");
                    table.CheckConstraint("CK_Accounts_Status", "\"Status\" BETWEEN 0 AND 3");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartnerType = table.Column<short>(type: "smallint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UserProfiles_PartnerType", "\"PartnerType\" IS NULL OR \"PartnerType\" BETWEEN 0 AND 4");
                    table.ForeignKey(
